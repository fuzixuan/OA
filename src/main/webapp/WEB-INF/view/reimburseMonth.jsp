	...
	<div class="action  divaction">
		...
		<div class="pages">
			<form id="claimVoucherStatistics_getDeptStatisticsByMonth_action"
				name="queryForm"
				action="../jboa/statistics/monthList?pageNum=${PAGE.pageNum }&pageSize=${PAGE.pageSize }"
				method="get">
				...
				<tbody>
					<c:forEach items="${PAGE.list }" var="temp" varStatus="status">
						<tr>
							...
							<td><a target="rightFrame" href="/jboa/statistics/monthDetails?departmentId=${temp.departmentId }&month=${temp.month}"> 
